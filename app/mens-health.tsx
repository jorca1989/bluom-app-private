...
const s = StyleSheet.create({
  ...
  // Quiz
  quizScreen: { flex: 1, backgroundColor: '#F5F4F0' },
  quizTopBar: { flexDirection: 'row', alignItems: 'center', padding: 16, gap: 12 },
  quizBack: { width: 36, height: 36, borderRadius: 18, backgroundColor: '#ffffff', alignItems: 'center', justifyContent: 'center' },
  quizProgress: { flex: 1, height: 4, backgroundColor: '#e2e8f0', borderRadius: 2, overflow: 'hidden' },
  ...
  quizQuestion: { fontSize: 22, fontWeight: '800', color: '#1e293b', marginBottom: 8, lineHeight: 30 },
  quizHint: { fontSize: 12, color: '#64748b', marginBottom: 16, fontStyle: 'italic' },
  quizOptions: { gap: 10 },
  quizOption: { flexDirection: 'row', alignItems: 'center', gap: 12, backgroundColor: '#ffffff', borderRadius: 16, padding: 16, borderWidth: 1, borderColor: '#e2e8f0' },
  quizOptionIcon: { fontSize: 24 },
  quizOptionLabel: { fontSize: 15, fontWeight: '700', color: '#1e293b' },
  ...
  retakeBtn: { width: 34, height: 34, borderRadius: 10, backgroundColor: '#ffffff', alignItems: 'center', justifyContent: 'center' },

  // Tabs
  tabBar: { flexDirection: 'row', backgroundColor: '#F5F4F0', borderBottomWidth: 1, borderBottomColor: '#e2e8f0' },
  ...
  sectionTitle: { fontSize: 15, fontWeight: '800', color: '#1e293b', marginBottom: 10, marginTop: 4 },
  ...
  cPhaseChipLarge: { flex: 1, paddingVertical: 10, borderRadius: 12, borderWidth: 1, borderColor: '#e2e8f0', backgroundColor: '#ffffff', alignItems: 'center' },
  ...
  compBtnTxt: { fontSize: 12, color: '#1e293b', fontWeight: '800' },

  // Cycle phase card
  cyclePhaseCard: { backgroundColor: '#ffffff', borderRadius: 14, padding: 14, marginBottom: 14, borderLeftWidth: 4 },
  cyclePhaseTitle: { fontSize: 14, fontWeight: '800', marginBottom: 4 },
  cyclePhaseDesc: { fontSize: 13, color: '#64748b', lineHeight: 19 },

  // Actions
  actionTile: { flexDirection: 'row', alignItems: 'center', gap: 12, backgroundColor: '#ffffff', borderRadius: 16, padding: 14, marginBottom: 10, borderWidth: 1, borderColor: '#e2e8f0' },
  ...
  modalClose: { width: 34, height: 34, borderRadius: 10, backgroundColor: '#ffffff', alignItems: 'center', justifyContent: 'center' },
  tOptLive: { alignItems: 'center', backgroundColor: '#ffffff', borderRadius: 16, padding: 16, marginVertical: 16, borderWidth: 1, borderColor: '#e2e8f0' },
  ...
  sliderLabel: { fontSize: 13, fontWeight: '700', color: '#64748b' },
  sliderVal: { fontSize: 16, fontWeight: '900' },
  sliderTrack: { height: 4, backgroundColor: '#e2e8f0', borderRadius: 2, overflow: 'hidden', marginBottom: 10 },
  sliderFill: { height: '100%', borderRadius: 2 },
  sliderDots: { flexDirection: 'row', gap: 3 },
  sliderDot: { flex: 1, height: 28, borderRadius: 6, borderWidth: 1, borderColor: '#e2e8f0', backgroundColor: '#ffffff', alignItems: 'center', justifyContent: 'center' },
  sliderDotTxt: { fontSize: 10, fontWeight: '700', color: '#475569' },
  moodSync: { flexDirection: 'row', alignItems: 'center', gap: 6, backgroundColor: '#ffffff', borderRadius: 10, padding: 10, marginBottom: 16 },
  ...
  // Pelvic modal
  pelvicTitle: { fontSize: 24, fontWeight: '900', color: '#1e293b', textAlign: 'center', marginBottom: 6 },
  ...
  timerTime: { fontSize: 44, fontWeight: '900', color: '#1e293b' },
  ...
  pelvicFinishBtn: { backgroundColor: '#f1f5f9', borderRadius: 18, paddingHorizontal: 48, paddingVertical: 16, borderWidth: 1, borderColor: '#e2e8f0', width: '80%', alignItems: 'center' },
  ...
  suppGroupLabel: { fontSize: 13, fontWeight: '800', color: '#64748b' },
  suppCard: { backgroundColor: '#ffffff', borderRadius: 14, padding: 14, marginBottom: 10, borderWidth: 1, borderColor: '#e2e8f0' },
  suppTop: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', marginBottom: 6 },
  suppName: { fontSize: 15, fontWeight: '800', color: '#1e293b' },
  ...
  suppReason: { fontSize: 13, color: '#64748b', lineHeight: 18 },
  suppDisclaimer: { flexDirection: 'row', gap: 8, backgroundColor: '#ffffff', borderRadius: 12, padding: 12, marginTop: 8 },
  suppDisclaimerTxt: { flex: 1, fontSize: 11, color: '#64748b', lineHeight: 16 },

  // Health markers modal
  markerCard: { backgroundColor: '#ffffff', borderRadius: 14, padding: 14, marginBottom: 12, borderWidth: 1, borderColor: '#e2e8f0' },
  markerTop: { flexDirection: 'row', alignItems: 'center', gap: 10, marginBottom: 10 },
  markerIcon: { fontSize: 22 },
  markerName: { fontSize: 14, fontWeight: '800', color: '#1e293b' },
  markerNormal: { fontSize: 11, color: '#64748b', marginTop: 2 },
  markerInput: { backgroundColor: '#f8fafc', borderRadius: 10, borderWidth: 1, borderColor: '#e2e8f0', padding: 12, fontSize: 15, color: '#1e293b', marginBottom: 8, fontWeight: '600' },
  markerTip: { fontSize: 12, color: '#64748b', lineHeight: 17 },

  // Peak week modal
  peakDayRow: { flexDirection: 'row', gap: 6, marginBottom: 20, flexWrap: 'wrap' },
  peakDayBtn: { flex: 1, minWidth: 44, paddingVertical: 10, borderRadius: 10, borderWidth: 1, borderColor: '#e2e8f0', backgroundColor: '#ffffff', alignItems: 'center' },
  peakDayTxt: { fontSize: 11, fontWeight: '700', color: '#64748b' },
  peakDayCard: { backgroundColor: '#ffffff', borderRadius: 14, padding: 16, borderWidth: 1, borderColor: '#e2e8f0' },
  peakDayCardTitle: { fontSize: 15, fontWeight: '800', color: '#fcd34d', marginBottom: 8 },
  peakDayCardBody: { fontSize: 13, color: '#64748b', lineHeight: 20 },
  carbLoadToggle: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', backgroundColor: '#ffffff', borderRadius: 12, padding: 14, marginTop: 14 },
  carbLoadLabel: { fontSize: 14, fontWeight: '700', color: '#1e293b' },

  // Track tab
  historyChart: { backgroundColor: '#ffffff', borderRadius: 18, padding: 16, marginBottom: 14 },
  ...
  historyScore: { fontSize: 11, fontWeight: '800', color: '#64748b', width: 34, textAlign: 'right' },

  pillarCard: { backgroundColor: '#ffffff', borderRadius: 14, padding: 14, marginBottom: 10 },
  pillarTop: { flexDirection: 'row', alignItems: 'center', gap: 8, marginBottom: 8 },
  pillarEmoji: { fontSize: 18 },
  pillarName: { flex: 1, fontSize: 14, fontWeight: '700', color: '#1e293b' },
  pillarScore: { fontSize: 16, fontWeight: '900' },
  pillarBar: { height: 4, backgroundColor: '#e2e8f0', borderRadius: 2, overflow: 'hidden', marginBottom: 8 },
  pillarBarFill: { height: '100%', borderRadius: 2 },
  pillarTip: { fontSize: 12, color: '#64748b', lineHeight: 18 },

  cycleTracker: { backgroundColor: '#ffffff', borderRadius: 18, padding: 16, marginBottom: 14 },
  ...
  cycleWeekLabel: { fontSize: 14, fontWeight: '700', color: '#1e293b' },
  cycleWeekBtns: { flexDirection: 'row', gap: 8 },
  cycleWeekBtn: { width: 34, height: 34, borderRadius: 10, backgroundColor: '#e2e8f0', alignItems: 'center', justifyContent: 'center' },
  cycleWeekBtnTxt: { fontSize: 18, fontWeight: '900', color: '#1e293b' },
  cycleProgressBar: { height: 5, backgroundColor: '#e2e8f0', borderRadius: 3, overflow: 'hidden' },
  cycleProgressFill: { height: '100%', backgroundColor: '#60a5fa', borderRadius: 3 },

  markerChip: { flexDirection: 'row', alignItems: 'center', backgroundColor: '#ffffff', borderRadius: 12, padding: 12, marginBottom: 8, gap: 10 },
  markerChipIcon: { fontSize: 18 },
  markerChipName: { fontSize: 13, fontWeight: '700', color: '#1e293b' },
  ...
  peakWeekCard: { backgroundColor: '#ffffff', borderRadius: 16, padding: 18, borderWidth: 1, borderColor: '#92400e' },
  peakWeekTitle: { fontSize: 16, fontWeight: '800', color: '#fcd34d', marginBottom: 6 },
  peakWeekSub: { fontSize: 13, color: '#64748b', lineHeight: 19, marginBottom: 10 },
  peakWeekCta: { fontSize: 13, fontWeight: '800', color: '#fcd34d' },

  // Insights
  insightCard: { flexDirection: 'row', alignItems: 'flex-start', gap: 12, backgroundColor: '#ffffff', borderRadius: 14, padding: 14, marginBottom: 10, borderLeftWidth: 4 },
  insightEmoji: { fontSize: 22, marginTop: 2 },
  insightTitle: { fontSize: 14, fontWeight: '800', color: '#1e293b', marginBottom: 4 },
  insightBody: { fontSize: 13, color: '#64748b', lineHeight: 19 },

  proBlurWrap: { borderRadius: 16, overflow: 'hidden', height: 160, backgroundColor: '#ffffff', marginBottom: 14 },
  proBlurContent: { flex: 1, alignItems: 'center', justifyContent: 'center', padding: 20 },
  proBlurTitle: { fontSize: 16, fontWeight: '800', color: '#1e293b', marginBottom: 6, textAlign: 'center' },
  ...
  proBlurBtnTxt: { color: '#1e293b', fontWeight: '800', fontSize: 14 },

  // Learn
  articleCard: { flexDirection: 'row', alignItems: 'center', backgroundColor: '#ffffff', borderRadius: 14, padding: 14, marginBottom: 10, gap: 12, borderWidth: 1, borderColor: '#e2e8f0' },
  ...
  articleCardTitle: { fontSize: 14, fontWeight: '700', color: '#1e293b', lineHeight: 19 },
  articleHeader: { flexDirection: 'row', gap: 12, padding: 20, paddingBottom: 16, borderBottomWidth: 1, borderBottomColor: '#e2e8f0' },
  articleCategory: { fontSize: 11, color: '#64748b', fontWeight: '700', textTransform: 'uppercase', marginBottom: 4 },
  articleTitle: { fontSize: 20, fontWeight: '900', color: '#1e293b', lineHeight: 26 },
  articleClose: { width: 34, height: 34, borderRadius: 10, backgroundColor: '#ffffff', alignItems: 'center', justifyContent: 'center' },
  articleBody: { fontSize: 15, color: '#64748b', lineHeight: 24, marginBottom: 20 },
  articleDisclaimer: { flexDirection: 'row', gap: 8, backgroundColor: '#ffffff', borderRadius: 12, padding: 12 },
