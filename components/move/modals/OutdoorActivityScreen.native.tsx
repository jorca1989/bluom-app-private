...
export default function OutdoorActivityScreen({
  ...
  // Previously these were AFTER the early return, which violated React's
  // Rules of Hooks and caused the component to silently corrupt after
  // one successful render, preventing the modal from ever opening again.
  ...
  const nativeModulesMissing = !Location || !TaskManager || !MapView || !Polyline || !Marker || !isMapNativelyLinked;

  if (nativeModulesMissing) {
    return (
