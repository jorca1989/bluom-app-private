...
export const ALL_ACHIEVEMENTS: AchievementDef[] = [
  ...
  // ── FUEL ──────────────────────────────────────────────────
  { id: 'first_meal_log',       title: 'First Bite',           description: 'Log your first meal in Fuel',              icon: '🍽️', category: 'fuel', rarity: 'common',    xpReward: 50,  tokenReward: 5  },
  { id: 'log_7_days_meals',     title: 'Consistent Eater',     description: 'Log meals for 7 days in a row',            icon: '📅', category: 'fuel', rarity: 'rare',      xpReward: 150, tokenReward: 15 },
  { id: 'log_30_days_meals',    title: 'Nutrition Master',     description: 'Log meals for 30 consecutive days',        icon: '🥗', category: 'fuel', rarity: 'epic',      xpReward: 400, tokenReward: 40 },
  { id: 'hit_protein_goal',     title: 'Protein Puncher',      description: 'Hit your daily protein goal',              icon: '🥩', category: 'fuel', rarity: 'common',    xpReward: 75,  tokenReward: 8  },
  { id: 'hit_protein_7days',    title: 'Protein Streak',       description: 'Hit protein goal 7 days in a row',         icon: '💪', category: 'fuel', rarity: 'rare',      xpReward: 200, tokenReward: 20 },
  { id: 'water_goal_day',       title: 'Hydrated',             description: 'Hit your water goal for the day',          icon: '💧', category: 'fuel', rarity: 'common',    xpReward: 50,  tokenReward: 5  },
  { id: 'water_goal_7days',     title: 'River Flow',           description: 'Hit water goal 7 days in a row',           icon: '🌊', category: 'fuel', rarity: 'rare',      xpReward: 175, tokenReward: 18 },
  { id: 'water_goal_30days',    title: 'Ocean Mind',           description: 'Hit water goal 30 days in a row',          icon: '🐋', category: 'fuel', rarity: 'epic',      xpReward: 450, tokenReward: 45 },
  { id: 'ai_meal_scan',         title: 'Food Detective',       description: 'Scan a meal with AI camera',               icon: '📸', category: 'fuel', rarity: 'common',    xpReward: 60,  tokenReward: 6  },
  { id: 'under_calorie_goal',   title: 'Deficit Day',          description: 'Stay within your calorie goal',            icon: '🎯', category: 'fuel', rarity: 'common',    xpReward: 75,  tokenReward: 8  },
  { id: 'calorie_goal_14days',  title: 'Precision Eater',      description: 'Hit calorie goal 14 days straight',        icon: '⚖️', category: 'fuel', rarity: 'epic',      xpReward: 350, tokenReward: 35 },
  ...
  { id: 'try_new_recipe',       title: 'Kitchen Explorer',     description: 'Cook from a Bluom recipe',                 icon: '👨‍🍳', category: 'fuel', rarity: 'common',    xpReward: 80,  tokenReward: 8  },
  { id: 'sugar_free_day',       title: 'Sugar Slayer',         description: 'Complete a sugar-free day',                icon: '🚫', category: 'fuel', rarity: 'common',    xpReward: 100, tokenReward: 10 },
  { id: 'sugar_free_7days',     title: 'Sweet Detox',          description: 'Go sugar-free for 7 days',                 icon: '🏅', category: 'fuel', rarity: 'rare',      xpReward: 300, tokenReward: 30 },
  { id: 'sugar_free_30days',    title: 'Sugar Reset Champion', description: '30 consecutive sugar-free days',           icon: '🥇', category: 'fuel', rarity: 'legendary', xpReward: 800, tokenReward: 80 },
  ...
  { id: 'workout_7days',        title: 'Week Warrior',         description: 'Work out 7 days in a row',                 icon: '🔥', category: 'move', rarity: 'rare',      xpReward: 200, tokenReward: 20 },
  { id: 'workout_30days',       title: 'Iron Discipline',      description: '30 consecutive workout days',              icon: '⚡', category: 'move', rarity: 'epic',      xpReward: 500, tokenReward: 50 },
  ...
  { id: 'steps_10k_7days',      title: 'Step Streak',          description: '10,000 steps for 7 days running',         icon: '🏃', category: 'move', rarity: 'rare',      xpReward: 300, tokenReward: 30 },
  ...
  { id: 'try_strength',         title: 'Iron Touch',           description: 'Log a strength training session',         icon: '🏋️', category: 'move', rarity: 'common',    xpReward: 60,  tokenReward: 6  },
  ...
  { id: 'complete_4week_plan',  title: 'Blueprint Complete',   description: 'Finish the full 4-week free plan',        icon: '📅', category: 'move', rarity: 'epic',      xpReward: 500, tokenReward: 50 },
  { id: 'total_10_workouts',    title: 'Double Digits',        description: 'Log 10 total workouts',                   icon: '🎯', category: 'move', rarity: 'common',    xpReward: 150, tokenReward: 15 },
  { id: 'total_50_workouts',    title: 'Half Century',         description: 'Log 50 total workouts',                   icon: '🏆', category: 'move', rarity: 'rare',      xpReward: 400, tokenReward: 40 },
  { id: 'total_100_workouts',   title: 'Century Club',         description: 'Log 100 total workouts',                  icon: '💯', category: 'move', rarity: 'legendary', xpReward: 1000, tokenReward: 100 },

  // ── WELLNESS ──────────────────────────────────────────────
  { id: 'first_mood_log',       title: 'Feeling Check',        description: 'Log your mood for the first time',        icon: '😊', category: 'wellness', rarity: 'common',    xpReward: 40,  tokenReward: 4  },
  ...
  { id: 'sleep_8hrs_7days',     title: 'Sleep Champion',       description: '8+ hours sleep for 7 consecutive days',  icon: '⭐', category: 'wellness', rarity: 'rare',      xpReward: 250, tokenReward: 25 },
  { id: 'perfect_vitality',     title: 'Peak Human',           description: 'Score 90+ on Vitality Score',            icon: '⚡', category: 'wellness', rarity: 'epic',      xpReward: 350, tokenReward: 35 },
  { id: 'stress_low_week',      title: 'Calm Commander',       description: 'Log low stress 7 days running',          icon: '🌊', category: 'wellness', rarity: 'rare',      xpReward: 200, tokenReward: 20 },
  ...
  { id: 'journal_7days',        title: 'Reflective Week',      description: 'Journal for 7 consecutive days',          icon: '✍️', category: 'mind', rarity: 'rare',      xpReward: 175, tokenReward: 18 },
  ...
  { id: 'gratitude_7days',      title: 'Gratitude Streak',     description: 'Practise gratitude 7 days in a row',     icon: '💛', category: 'mind', rarity: 'rare',      xpReward: 175, tokenReward: 18 },
  { id: 'gratitude_30days',     title: 'Abundance Mindset',    description: 'Gratitude logged for 30 straight days',  icon: '🌟', category: 'mind', rarity: 'epic',      xpReward: 450, tokenReward: 45 },
  { id: 'ai_reflection',        title: 'Digital Mirror',       description: 'Generate your first AI mental insight',  icon: '✨', category: 'mind', rarity: 'rare',      xpReward: 150, tokenReward: 15 },
  ...
  { id: 'habit_7day_streak',    title: 'Habit Locked',         description: 'Keep a habit streak for 7 days',         icon: '🔗', category: 'habits', rarity: 'rare',      xpReward: 175, tokenReward: 18 },
  { id: 'habit_21day_streak',   title: 'Wired In',             description: '21-day habit streak — now it\'s wired',  icon: '🧬', category: 'habits', rarity: 'epic',      xpReward: 400, tokenReward: 40 },
  { id: 'habit_66day_streak',   title: 'Automatic',            description: '66-day streak — science says it\'s permanent', icon: '🤖', category: 'habits', rarity: 'legendary', xpReward: 1000, tokenReward: 100 },
  { id: 'all_habits_today',     title: 'Clean Sweep',          description: 'Complete every habit in a single day',   icon: '✅', category: 'habits', rarity: 'rare',      xpReward: 200, tokenReward: 20 },
  { id: 'break_habit_7days',    title: 'Breaking Free',        description: 'Go 7 days without a bad habit',          icon: '🔓', category: 'habits', rarity: 'rare',      xpReward: 200, tokenReward: 20 },
  ...
  { id: 'habit_savings_100',    title: 'Money Saved',          description: 'Save €/£/$100 by quitting a habit',     icon: '💰', category: 'habits', rarity: 'rare',      xpReward: 250, tokenReward: 25 },

  // ── PRODUCTIVITY ──────────────────────────────────────────
  { id: 'first_task',           title: 'Getting Started',      description: 'Add your first task to the hub',         icon: '📝', category: 'productivity', rarity: 'common',    xpReward: 30,  tokenReward: 3  },
  { id: 'complete_10_tasks',    title: 'Task Crusher',         description: 'Complete 10 tasks',                      icon: '✅', category: 'productivity', rarity: 'common',    xpReward: 100, tokenReward: 10 },
  ...
  { id: 'focus_first_session',  title: 'Deep Work',            description: 'Complete your first Focus Mode session', icon: '🎯', category: 'productivity', rarity: 'common',    xpReward: 60,  tokenReward: 6  },
  { id: 'focus_7_sessions',     title: 'Flow State Regular',   description: 'Complete 7 Focus Mode sessions',         icon: '🌀', category: 'productivity', rarity: 'rare',      xpReward: 200, tokenReward: 20 },
  ...
  { id: 'weight_goal_reached',  title: 'Target Achieved',      description: 'Reach your target body weight',          icon: '🎯', category: 'health', rarity: 'legendary', xpReward: 1000, tokenReward: 100, secret: true },
  ...
  { id: 'first_fast',           title: 'Fast Starter',         description: 'Complete your first fasting session',    icon: '⏰', category: 'health', rarity: 'common',    xpReward: 60,  tokenReward: 6  },
  ...
  { id: 'fast_24hrs',           title: 'One Day Fast',         description: 'Complete a 24-hour fast',                icon: '🔮', category: 'health', rarity: 'rare',      xpReward: 250, tokenReward: 25 },
  { id: 'fast_7streak',         title: 'Fasting Practitioner', description: '7 consecutive fasting days',             icon: '⚡', category: 'health', rarity: 'epic',      xpReward: 450, tokenReward: 45 },
  { id: 'bio_log_first',        title: 'Bio Aware',            description: 'Complete your first Bio-Log check-in',   icon: '🔬', category: 'health', rarity: 'common',    xpReward: 50,  tokenReward: 5  },
  ...
  { id: 'pelvic_first',         title: 'Protocol Starter',     description: 'Complete your first Pelvic Power session', icon: '🏅', category: 'health', rarity: 'common',    xpReward: 60,  tokenReward: 6  },
  { id: 'supplements_7days',    title: 'Stack Consistent',     description: 'Log supplements 7 days in a row',        icon: '💊', category: 'health', rarity: 'rare',      xpReward: 150, tokenReward: 15 },
  ...
  // ── AI ────────────────────────────────────────────────────
  { id: 'ai_first_message',     title: 'Coach Activated',      description: 'Send your first message to AI Coach',    icon: '🤖', category: 'ai', rarity: 'common',    xpReward: 50,  tokenReward: 5  },
  { id: 'ai_10_messages',       title: 'Coachable',            description: 'Have 10 conversations with AI Coach',    icon: '💬', category: 'ai', rarity: 'rare',      xpReward: 175, tokenReward: 18 },
  { id: 'ai_plan_generated',    title: 'Blueprint Built',      description: 'Generate your first AI personalised plan', icon: '🧬', category: 'ai', rarity: 'epic',      xpReward: 300, tokenReward: 30 },
  ...
  { id: 'ai_recipe_generated',  title: 'AI Chef',              description: 'Generate an AI recipe',                  icon: '👨‍🍳', category: 'ai', rarity: 'rare',      xpReward: 150, tokenReward: 15 },
  { id: 'ai_insight_generated', title: 'Digital Mirror',       description: 'Unlock your AI mental weather report',   icon: '🌤️', category: 'ai', rarity: 'rare',      xpReward: 150, tokenReward: 15 },
  ...
  { id: 'partner_synced_week',  title: 'Team Player',          description: 'Stay synced with your partner for a week', icon: '🤝', category: 'social', rarity: 'rare',      xpReward: 200, tokenReward: 20 },
  ...
  { id: 'all_tabs_used',        title: 'Super App User',       description: 'Use Fuel, Move, Wellness and Mind tabs',  icon: '⭐', category: 'milestone', rarity: 'rare',      xpReward: 200, tokenReward: 20 },
  ...
  { id: 'streak_365_days',      title: 'Year of Bluom',        description: 'Use Bluom every single day for a year',  icon: '👑', category: 'milestone', rarity: 'legendary', xpReward: 5000, tokenReward: 500, secret: true },
  { id: 'xp_1000',              title: 'Rising',               description: 'Earn 1,000 XP',                          icon: '✨', category: 'milestone', rarity: 'common',    xpReward: 0,  tokenReward: 10 },
