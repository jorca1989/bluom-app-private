...
export const createExercise = mutation({
    args: {
        ...
        type: v.union(v.literal("strength"), v.literal("cardio"), v.literal("hiit"), v.literal("yoga"), v.literal("functional"), v.literal("warmup"), v.literal("calisthenics"), v.literal("plyometrics"), v.literal("balance")),
...
export const updateExercise = mutation({
    args: {
        ...
        updates: v.object({
            ...
            categories: v.optional(v.array(v.string())),
            type: v.optional(v.union(v.literal("strength"), v.literal("cardio"), v.literal("hiit"), v.literal("yoga"), v.literal("functional"), v.literal("warmup"), v.literal("calisthenics"), v.literal("plyometrics"), v.literal("balance"))),
            types: v.optional(v.array(v.string())),
